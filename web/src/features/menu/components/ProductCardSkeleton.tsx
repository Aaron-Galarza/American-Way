export const ProductCardSkeleton = () => {
  return (
    <div className="flex h-full animate-pulse flex-col overflow-hidden rounded-2xl border border-white/12 bg-primary/35">
      ...
      <div className="flex flex-1 flex-col gap-3 p-4">
        ...
        <div className="flex items-center justify-between border-t border-white/10 pt-3">
          ...
          <div className="h-10 w-24 rounded-full bg-secondary/35" />
        </div>
      </div>
    </div>
  );
